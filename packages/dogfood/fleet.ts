...
import { APPS, DOOR, HOST } from './demos/APPS.ts'
...
const here = boot('dogfood', import.meta.dir, HOST, null)
const demos = APPS.map((app) => ({ app, child: boot(app.name, `${import.meta.dir}/../${app.name}`, app.port, app.prefix) }))
