...
//
// `#shared/demos/transport.ts` carries both laws — coalescing, the shared surface, streams, rooms, the
...
import { registered } from 'abide/server/internal'
...
import { APP_ROOT, REPO_ROOT, SERVER as APP_SERVER } from '#tests/PATHS.ts'

const SERVER = `${APP_SERVER}/`
