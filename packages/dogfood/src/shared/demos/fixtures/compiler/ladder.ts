...
export const LADDER: Example[] = [
    { adds: 'read and write by NAME — and the explicit spelling still compiles', of: ['state'], source: ONE, view: One },
    { adds: 'naming a cell alone hands over the CELL rather than reading it', of: ['state'], source: TWO, view: Two },
