...
export const LADDER: Example[] = [
    { adds: 'render a component — one walk, in document order', of: ['render'], source: ONE, view: One },
    { adds: 'a region that SUSPENDS: the shell goes out, the rest follows', of: ['render'], source: TWO, view: Two },
]
