...
// `#tests/unit/lifecycle.test.ts`, spawned, for the same reason `serve`'s interleaving does.

import { error, json, middleware, onError, onStart, onStop } from 'abide/server'
import { boot, handle, shutdown } from 'abide/server/internal'
