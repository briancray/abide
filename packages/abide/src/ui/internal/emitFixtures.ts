...
const serverCard = async (
    props: Record<string, unknown>,
    children: () => Promise<{ toString(): string }>,
...
export const FIXTURES: Fixture[] = [
    ...
    {
        name: 'interpolation escapes',
        src: '{value}',
        kind: 'template',
        scope: () => ({ value: '<b>x</b>' }),
    },
    {
        name: 'quotes/ampersands escaped',
        src: '{value}',
        kind: 'template',
        scope: () => ({ value: `a & "b" 'c'` }),
    },
    {
        name: 'undefined renders empty',
        src: '[{value}]',
        kind: 'template',
    ...
    {
        name: 'static attr escaped',
        src: '<a title="a&b">x</a>',
        kind: 'template',
        scope: () => ({}),
    },
    {
        name: 'expr attr string',
        src: '<input type={t}>',
        kind: 'template',
        scope: () => ({ t: 'text' }),
    },
    {
        name: 'expr attr false',
        src: '<input disabled={d}>',
        kind: 'template',
        scope: () => ({ d: false }),
    },
    {
    ...
    {
        name: 'boolean static attr',
        src: '<input type="text" required>',
        kind: 'template',
        scope: () => ({}),
    },
    {
        name: 'event omitted server',
        src: '<button onclick={fn}>x</button>',
        kind: 'template',
        scope: () => ({ fn: () => {} }),
        client: false,
    },
    ...
    {
        name: 'bind:value server',
        src: '<input bind:value={v}>',
        kind: 'template',
        scope: () => ({ v: 'hello' }),
        client: false,
    },
    {
        name: 'bind:checked server',
        src: '<input bind:checked={c}>',
        kind: 'template',
        scope: () => ({ c: true }),
        client: false,
    },
    ...
    {
        name: 'for array',
        src: '{#for x of list}<li>{x}</li>{/for}',
        kind: 'template',
        scope: () => ({ list: ['a', 'b'] }),
    },
    {
        name: 'for index',
        src: '{#for x, i of list}<li>{i}:{x}</li>{/for}',
        kind: 'template',
        scope: () => ({ list: ['a', 'b'] }),
    },
    {
    ...
    {
        name: 'for await array',
        src: '{#for await x of src}<i>{x}</i>{/for}',
        kind: 'template',
        scope: () => ({ src: [1, 2] }),
        client: false,
    },
    ...
    {
        name: 'for keyed by key',
        src: '{#for x of list by x}<li>{x}</li>{/for}',
        kind: 'template',
        scope: () => ({ list: ['a', 'b'] }),
    },
    {
    ...
    {
        name: 'switch match',
        src: '{#switch n}{:case 1}one{:case 2}two{:default}other{/switch}',
        kind: 'template',
        scope: () => ({ n: 2 }),
    },
    {
        name: 'switch default',
        src: '{#switch n}{:case 1}one{:default}other{/switch}',
        kind: 'template',
        scope: () => ({ n: 9 }),
    },
    {
        name: 'switch no match',
        src: '{#switch n}{:case 1}one{/switch}',
        kind: 'template',
        scope: () => ({ n: 9 }),
    },
    ...
    {
        name: 'try finally',
        src: '{#try}a{:catch e}b{:finally}!{/try}',
        kind: 'template',
        scope: () => ({}),
    },
    ...
    },
    {
        ...
        client: false,
        scope: () => ({
            Card: async (props: Record<string, unknown>) => `<b>${props.a}-${props.b}</b>`,
            data: { a: 1, b: 2 },
        }),
    },
    {
    ...
    // --- styles / scripts ------------------------------------------------------
    {
        name: 'script emits nothing',
        src: '<script>let x = 1</script><p>{n}</p>',
        kind: 'template',
        scope: () => ({ n: 5 }),
    },
    {
