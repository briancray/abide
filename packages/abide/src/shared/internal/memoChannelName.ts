...
// here — importable from BOTH the broadcast registry (`memoChannels.ts`, alongside this file) and
...
export function memoChannelName(rpcName: string, args: unknown): string {
