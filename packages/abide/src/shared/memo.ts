...
import { type AutoBacking, createAutoBacking } from './internal/autoBacking.ts'
...
import { isStreamSource } from './internal/isStreamSource.ts'
...
export function memo<Args, T>(
    ...
    function resolveMode(slot: Slot<Args, T>): void {
        ...
        const backing = createAutoBacking<T>({
            body: () => fn(slot.args),
            runFillBody,
            clockMs,
            clockIsDebounce,
