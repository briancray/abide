...
/*
belte-ui-native port of `svelte/reactivity`'s `createSubscriber`: open-on-first-
read, close-on-last-reader, grounded in belte's own signal core (no Svelte). The
...
read inside a belte-ui effect/derived, registers that reader (via `track`) and
