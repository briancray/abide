...
disconnected component (the user's src/bundle/disconnected.belte override or the
...
belte-ui component's default export is its mounter, so calling it mounts.
*/
