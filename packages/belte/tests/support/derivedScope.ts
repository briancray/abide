...
/*
Like reactiveScope's track(), but routes the read through a belte-ui derived so it
evaluates in derived context. belte-ui places no write restriction inside derived
...
belte-ui-native (no Svelte) — replaces the former $derived.by harness.
*/
