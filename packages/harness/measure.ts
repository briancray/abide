// The measurement half of the harness, and the half with NO ABIDE IN ITS GRAPH.
//
...
//   · the two probes it needs are the harness's own copies — see `internal/probes.ts` for why six
//     duplicated lines are the correct price for the boundary.
//
// Assertions are NOT here. They are on `harness`, beside the `Case` that carries them: an assertion
