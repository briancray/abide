...
export const LADDER: Example[] = [
    { adds: "the app's own channel always writes — and so do `warning` and `error`", source: ONE },
    { adds: 'a named channel, off until `DEBUG` names it', source: TWO },
    { adds: '`enabled()`, for when building the message is the cost', source: THREE },
]
